                    ...
                    <el-form ref="form" :model="form" :rules="rules" label-width="100px">
                        ...
                        <el-form-item label="类型:">
                            <el-radio-group v-model="form.tag">
                                ...
                                <el-radio label="middleware">中间件</el-radio>
                            </el-radio-group>
                        </el-form-item>
                        ...
                        <el-form-item label="监控项:" prop="metric">
                            <el-table :data="form.items" border style="width: 100%;">
                                <el-table-column prop="key" label="名称" width="300"></el-table-column>
    ...
    methods: {
        ...
        on_submit_form() {
            this.$refs.form.validate(valid => {
                ...
                if (this.route_id) {
                    // 修改
                    this.form.id = Number(this.route_id);
                    this.$fetch.monitorApi
                        .put(this.form)
                        .then(response => {
        ...
        handleEdit(index, row) {
            ...
            setTimeout((this.dialogFormVisible = true), 200);
        },
